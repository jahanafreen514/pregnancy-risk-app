...
const Suggestions = () => {
  ...
  const generateSuggestions = useCallback(
    (
      ...
      const babyWeight = Number(vitals?.babyWeight) || 0;
      const babyHeartRate = Number(vitals?.babyHeartRate) || 0;
      const cervicalLength = Number(vitals?.cervicalLength) || 0;
      ...
      if (riskData?.risk === "High") {
        list.push({
          ...
          message:
            "Please contact your doctor immediately. Monitor blood pressure twice daily and avoid heavy work. Seek emergency care if you experience any severe symptoms.",
          type: "critical",
        ...
        list.push({
          ...
          message:
            "Schedule an emergency appointment with your gynecologist today. Do not delay medical attention.",
          type: "critical",
        ...
        if (
          ...
          list.push({
            ...
            message: `Risk factors detected: ${riskData.riskFactors
              .slice(0, 3)
              .join(
                ", "
        ...
        list.push({
          ...
          message:
            "Continue medications regularly and attend weekly checkups. Monitor your symptoms closely and report any changes to your doctor.",
          type: "warning",
          icon: (
        ...
        list.push({
          ...
          message:
            "Don't forget your scheduled weekly checkup with your doctor. Regular monitoring is important at this stage.",
          type: "warning",
        ...
        list.push({
          ...
          message:
            "Maintain a balanced diet and continue regular prenatal checkups. You're doing great! Keep up the healthy habits.",
          type: "success",
        ...
        list.push({
          ...
          message:
            "Your healthy habits are making a difference. Stay consistent with your routine and enjoy this beautiful journey.",
          type: "success",
      ...
      if (water < 8) {
        list.push({
          ...
          message: `Drink ${
            8 - water
          } more glasses of water today. Stay hydrated for a healthy pregnancy.`,
          type: "info",
        ...
        list.push({
          ...
          message:
            "You've met your water intake goal for today. Keep it up!",
          type: "success",
          icon: <FaCheckCircle className="text-green-500" />,
        });
      }
      ...
      if (heartRate > 100) {
        list.push({
          ...
          message:
            "Your heart rate is slightly high. Rest for a while and consult your doctor if it remains elevated.",
          type: "warning",
        ...
        list.push({
          ...
          message:
            "Your heart rate is below normal. Please consult your doctor if you feel dizzy or fatigued.",
          type: "warning",
      ...
      if (trimester === "1st") {
        list.push({
          ...
          message:
            "Take folic acid daily and get plenty of rest. Avoid stress and eat small frequent meals. Stay hydrated.",
          type: "info",
        ...
        list.push({
          ...
          message:
            "Increase calcium, protein and iron-rich foods. Stay active with gentle exercises like walking and prenatal yoga.",
          type: "info",
          icon: <FaBaby className="text-purple-500" />,
        });
      } else {
        list.push({
          ...
          message:
            "Monitor baby's movements daily. Prepare for delivery and pack your hospital bag. Stay active with light exercises.",
          type: "info",
          icon: <FaBaby className="text-purple-500" />,
        });
      }
      ...
      if (medications && medications.length > 0) {
        ...
        if (pendingMeds.length > 0) {
          const medicationNames = pendingMeds
            .map((m) => m.name)
            .filter(Boolean)
            .join(", ");
          ...
          list.push({
            ...
            message:
              "Great job! You've taken all your medications for today.",
            type: "success",
            icon: (
      ...
      if (
        ...
        list.push({
          ...
          message: `You've reported: ${riskData.symptoms
            .slice(0, 3)
            .join(", ")}${
            riskData.symptoms.length > 3
              ? ` and ${
                  riskData.symptoms.length - 3
                } more`
              : ""
          }. Keep monitoring and report any new symptoms.`,
          type: "info",
          icon: (
        ...
        list.push({
          ...
          message:
            "You haven't reported any symptoms today. Continue maintaining your healthy routine.",
          type: "success",
          icon: (
            <FaCheckCircle className="text-green-500" />
          ),
      ...
      if (appointments && appointments.length > 0) {
        ...
        list.push({
          ...
          message: `Your next appointment is scheduled for ${
            upcoming.date || "N/A"
          } at ${upcoming.time || "N/A"} with ${
            upcoming.doctor || "your doctor"
          }.`,
          type: "info",
          icon: (
        ...
        list.push({
          ...
          message:
            "You don't have any upcoming appointments. Book one to stay on track with your pregnancy care.",
          type: "info",
          icon: (
            <FaCalendarAlt className="text-blue-500" />
          ),
  ...
  const loadUserData = useCallback(() => {
    ...
    // Heart rate
    const heartRate =
      Number(localStorage.getItem("heartRate")) || 0;

    const heartRateFromVitals =
      Number(riskData.vitals?.heartRate) || 0;

    const finalHeartRate =
      heartRate || heartRateFromVitals || 78;
    ...
    setHealthData({
      ...
      babyHeartRate:
        vitals.babyHeartRate || 0,

      cervicalLength:
        vitals.cervicalLength || 0,
      ...
      try {
        ...
        const apiRisk = {
          ...
          vitals: {
            ...
            week:
              timing.pregnancy_week ||
              latest.pregnancy_week ||
              0,
          },
        };
        ...
        let trimester = "Not recorded";

        if (timing.trimester) {
          const trimesterNumber =
            Number(timing.trimester);
        ...
        setHealthData((current) => ({
          ...
          heartRate:
            apiRisk.vitals.heartRate,

          bloodPressure:
            apiRisk.vitals.bpSystolic &&
            apiRisk.vitals.bpDiastolic
              ? `${apiRisk.vitals.bpSystolic}/${apiRisk.vitals.bpDiastolic}`
              : "Not recorded",
          ...
          temperature:
            apiRisk.vitals.temperature ||
            0,

          sugar:
            apiRisk.vitals.sugar || 0,

          week:
            apiRisk.vitals.week || 0,
        ...
        // Keep offline/localStorage data
        // if backend request fails.
        console.error(
          "Failed to refresh overview:",
          error
        );
      }
    };
            ...
            <div>
              ...
              <p className="text-white/90 text-sm mt-1">
                ...
                "High"
                  ...
                  : healthData.risk ===
                    "Moderate"
                  ? "regular monitoring and weekly checkups"
                  : "continuing your healthy routine and regular checkups"}
                .

                {healthData.week > 0 &&
                  ` You are currently in week ${healthData.week} of pregnancy.`}
              </p>
            </div>
          </div>
        </div>
          ...
          {suggestions.map(
            (suggestion) => (
              <div
                ...
                className={`bg-white/80 backdrop-blur-xl rounded-2xl p-5 border ${getTypeStyles(
                  suggestion.type
        ...
        <div className="grid md:grid-cols-2 gap-6 mb-6">
          ...
          <div className="bg-white/80 backdrop-blur-2xl rounded-2xl p-6 border border-white/70 shadow-lg">
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-center gap-3 text-sm text-gray-600">
                <span className="w-2 h-2 bg-green-500 rounded-full"></span>
                Include calcium sources like milk
                and cheese
              </li>

              <li className="flex items-center gap-3 text-sm text-gray-600">
                <span className="w-2 h-2 bg-green-500 rounded-full"></span>
                Consume folic acid through leafy
                greens
              </li>

              <li className="flex items-center gap-3 text-sm text-gray-600">
                <span className="w-2 h-2 bg-green-500 rounded-full"></span>
                Stay hydrated with 8-10 glasses
                of water
              </li>
            </ul>
          </div>
